...
final class GameResultViewModelTests: XCTestCase {
    func test_init_withNoWinner_configuresInitialValues() {
        let playerOne = PlayerResult(id: UUID(), name: "First player", answers: ["Q1": (answer: "A1", time: 1.0), "Q2": (answer: "A1", time: 1.5)], score: 1)
        let playerTwo = PlayerResult(id: UUID(), name: "Second player", answers: ["Q1": (answer: "A1", time: 1.2), "Q2": (answer: "A2", time: 1.7)], score: 1)
    ...
    func test_init_withWinner_configuresInitialValues() {
        let playerOne = PlayerResult(id: UUID(), name: "First player", answers: ["Q1": (answer: "A1", time: 1.0), "Q2": (answer: "A2", time: 1.5), "Q3": (answer: "A3", time: 1.5)], score: 3)
        let playerTwo = PlayerResult(id: UUID(), name: "Second player", answers: ["Q1": (answer: "A1", time: 1.2), "Q2": (answer: "A2", time: 1.7), "Q3": (answer: "A2", time: 1.2)], score: 1)
        let players = [playerOne, playerTwo]
